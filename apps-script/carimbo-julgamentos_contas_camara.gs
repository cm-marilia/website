 ...
 * Carimbo de atualização automático — planilha: julgamentos das contas
 * anuais da Câmara
 *
 ...
 *    só na 1ª SEGUNDA-FEIRA do mês, 9h-10h (os dados mudam ~1x/ano, não
 *    precisa de reforço semanal). Uma trava de 25s evita loop entre o
 *    carimbo e o próprio onChange.
 *
 ...
 *    os dados chegam por importação (que não passa pelo onEdit). Esta
 *    planilha não tem coluna de CPF hoje — a proteção fica pronta caso uma
 *    seja adicionada no futuro.
 *
